...
public class CActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id==R.id.navigates){
            textView_task.append(" C activity"+ System.getProperty("line.separator"));
            Intent I = new Intent(this, DActivity.class);
        ...
        if(id==android.R.id.home){
            textView_task.append(" back from C activity"+ System.getProperty("line.separator"));
